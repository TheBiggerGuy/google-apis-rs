...
extern crate mime;
extern crate strsim;
extern crate google_binaryauthorization1_beta1 as api;
...
impl<'n> Engine<'n> {
    ...
    fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match cmn::application_secret_from_directory(&config_dir, "binaryauthorization1-beta1-secret.json",
        ...
        let auth = Authenticator::new(  &secret, DefaultAuthenticatorDelegate,
                                        ...
                                        JsonTokenStorage {
                                          program_name: "binaryauthorization1-beta1",

...
impl<'n> Engine<'n> {
    fn _beaconinfo_getforobserved(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _beacons_activate(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _beacons_attachments_batch_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _beacons_attachments_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _beacons_attachments_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _beacons_attachments_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _beacons_deactivate(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _beacons_decommission(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _beacons_delete(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _beacons_diagnostics_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _beacons_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _beacons_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _beacons_register(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _beacons_update(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _namespaces_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _doit(&self, dry_run: bool) -> Result<Result<(), DoitError>, Option<InvalidOptionsError>> {
        ...
        match self.opt.subcommand() {
            ("beaconinfo", Some(opt)) => {
                match opt.subcommand() {
                    ("getforobserved", Some(opt)) => {
                        call_result = self._beaconinfo_getforobserved(opt, dry_run, &mut err);
                    },
                    _ => {
            ...
            ("beacons", Some(opt)) => {
                match opt.subcommand() {
                    ("activate", Some(opt)) => {
                        call_result = self._beacons_activate(opt, dry_run, &mut err);
                    },
                    ("attachments-batch-delete", Some(opt)) => {
                        call_result = self._beacons_attachments_batch_delete(opt, dry_run, &mut err);
                    },
                    ("attachments-create", Some(opt)) => {
                        call_result = self._beacons_attachments_create(opt, dry_run, &mut err);
                    },
                    ("attachments-delete", Some(opt)) => {
                        call_result = self._beacons_attachments_delete(opt, dry_run, &mut err);
                    },
                    ("attachments-list", Some(opt)) => {
                        call_result = self._beacons_attachments_list(opt, dry_run, &mut err);
                    },
                    ("deactivate", Some(opt)) => {
                        call_result = self._beacons_deactivate(opt, dry_run, &mut err);
                    },
                    ("decommission", Some(opt)) => {
                        call_result = self._beacons_decommission(opt, dry_run, &mut err);
                    },
                    ("delete", Some(opt)) => {
                        call_result = self._beacons_delete(opt, dry_run, &mut err);
                    },
                    ("diagnostics-list", Some(opt)) => {
                        call_result = self._beacons_diagnostics_list(opt, dry_run, &mut err);
                    },
                    ("get", Some(opt)) => {
                        call_result = self._beacons_get(opt, dry_run, &mut err);
                    },
                    ("list", Some(opt)) => {
                        call_result = self._beacons_list(opt, dry_run, &mut err);
                    },
                    ("register", Some(opt)) => {
                        call_result = self._beacons_register(opt, dry_run, &mut err);
                    },
                    ("update", Some(opt)) => {
                        call_result = self._beacons_update(opt, dry_run, &mut err);
                    },
                    _ => {

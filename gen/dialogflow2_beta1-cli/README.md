...
This documentation was generated from the *Dialogflow* API at revision *20181008*. The CLI is at version *1.0.7*.
...
dialogflow2-beta1 [options]
        projects
                ...
                conversations-contexts-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                conversations-contexts-delete <name> [-p <v>]... [-o <out>]
                conversations-contexts-get <name> [-p <v>]... [-o <out>]
                conversations-contexts-list <parent> [-p <v>]... [-o <out>]
                conversations-contexts-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                conversations-delete-contexts <parent> [-p <v>]... [-o <out>]

...
fn main() {
    ...
    let mut app = App::new("container1")
           ...
           .about("The Google Kubernetes Engine API is used for building and managing container based applications, powered by the open source Kubernetes technology.")

...
extern crate mime;
extern crate strsim;
extern crate google_language1 as api;
...
struct Engine<'n> {
    opt: ArgMatches<'n>,
    hub: api::CloudNaturalLanguage<hyper::Client, Authenticator<DefaultAuthenticatorDelegate, JsonTokenStorage, hyper::Client>>,
    gp: Vec<&'static str>,
...
impl<'n> Engine<'n> {
    fn _documents_analyze_entities(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _documents_analyze_entity_sentiment(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _documents_analyze_sentiment(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _documents_analyze_syntax(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _documents_annotate_text(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _documents_classify_text(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
            ...
            ("documents", Some(opt)) => {
                match opt.subcommand() {
                    ("analyze-entities", Some(opt)) => {
                        call_result = self._documents_analyze_entities(opt, dry_run, &mut err);
                    },
                    ("analyze-entity-sentiment", Some(opt)) => {
                        call_result = self._documents_analyze_entity_sentiment(opt, dry_run, &mut err);
                    },
                    ("analyze-sentiment", Some(opt)) => {
                        call_result = self._documents_analyze_sentiment(opt, dry_run, &mut err);
                    },
                    ("analyze-syntax", Some(opt)) => {
                        call_result = self._documents_analyze_syntax(opt, dry_run, &mut err);
                    },
                    ("annotate-text", Some(opt)) => {
                        call_result = self._documents_annotate_text(opt, dry_run, &mut err);
                    },
                    ("classify-text", Some(opt)) => {
                        call_result = self._documents_classify_text(opt, dry_run, &mut err);
                    },
                    _ => {
    ...
    fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match cmn::application_secret_from_directory(&config_dir, "language1-secret.json",
...
fn main() {
    ...
    let arg_data = [
        ("documents", "methods: 'analyze-entities', 'analyze-entity-sentiment', 'analyze-sentiment', 'analyze-syntax', 'annotate-text' and 'classify-text'", vec![
            ("analyze-entities",
                    Some(r##"Finds named entities (currently proper names and common nouns) in the text
        ...
        other properties."##),
            ...
            ("analyze-entity-sentiment",
                    Some(r##"Finds entities, similar to AnalyzeEntities in the text and analyzes
        sentiment associated with each entity and its mentions."##),
            ...
            ("analyze-syntax",
                    Some(r##"Analyzes the syntax of the text and provides sentence boundaries and
        ...
        properties."##),
            ...
            ("annotate-text",
                    Some(r##"A convenience method that provides all the features that analyzeSentiment,

...
impl<'n> Engine<'n> {
    fn _albums_add_enrichment(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _albums_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            match key {
                "share-token" => {
                    call = call.share_token(value.unwrap_or(""));
                },
                _ => {
                    let mut found = false;
                    for param in &self.gp {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["share-token"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn _albums_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _albums_share(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _media_items_batch_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _media_items_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _media_items_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _shared_albums_get(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            match key {
                "album-id" => {
                    call = call.album_id(value.unwrap_or(""));
                },
                _ => {
                    let mut found = false;
                    for param in &self.gp {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["album-id"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    fn _shared_albums_join(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    fn _shared_albums_list(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        match self.opt.subcommand() {
            ("albums", Some(opt)) => {
                match opt.subcommand() {
                    ...
                    ("get", Some(opt)) => {
                        call_result = self._albums_get(opt, dry_run, &mut err);
                    },
                    ("list", Some(opt)) => {
            ...
            ("media-items", Some(opt)) => {
                match opt.subcommand() {
                    ("batch-create", Some(opt)) => {
                        call_result = self._media_items_batch_create(opt, dry_run, &mut err);
                    },
                    ("get", Some(opt)) => {
                        call_result = self._media_items_get(opt, dry_run, &mut err);
                    },
                    ("list", Some(opt)) => {
            ...
            ("shared-albums", Some(opt)) => {
                match opt.subcommand() {
                    ("get", Some(opt)) => {
                        call_result = self._shared_albums_get(opt, dry_run, &mut err);
                    },
                    ("join", Some(opt)) => {
                        call_result = self._shared_albums_join(opt, dry_run, &mut err);
                    },
                    ("list", Some(opt)) => {
                        call_result = self._shared_albums_list(opt, dry_run, &mut err);
                    },
                    _ => {
...
fn main() {
    ...
    let arg_data = [
        ("albums", "methods: 'add-enrichment', 'create', 'get', 'list' and 'share'", vec![
            ("add-enrichment",
            ...
            ("get",
                    Some(r##"Returns the album based on the specified `albumId` or `shareToken`.
        ...
        album that the user has joined."##),
                  ...
                  vec![
                    (Some(r##"album-id"##),
                     None,
                     Some(r##"Identifier of the album to be requested. Must not be set if `shareToken` is
        set."##),
                     Some(true),
                     Some(false)),
            ...
            ("list",
                    Some(r##"Lists all albums shown to a user in the Albums tab of the Google
        Photos app."##),
        ...
        API."##),
                  ...
                  vec![
                    (Some(r##"album-id"##),
                     None,
                     Some(r##"Identifier of the album to be shared. This `albumId` must belong to an
        ...
        ("media-items", "methods: 'batch-create', 'get', 'list' and 'search'", vec![
            ("batch-create",
        ...
        in a `BAD REQUEST` error."##),
            ...
            ("get",
                    Some(r##"Returns the media item for the specified media item `id`."##),
                    "Details at http://byron.github.io/google-apis-rs/google_photoslibrary1_cli/media-items_get",
                  vec![
                    (Some(r##"media-item-id"##),
                     None,
                     Some(r##"Identifier of media item to be requested."##),
                     Some(true),
                     Some(false)),
            ...
            ("search",
                    Some(r##"Searches for media items in a user's Google Photos library.
        ...
        ("shared-albums", "methods: 'get', 'join' and 'list'", vec![
            ("get",
                    Some(r##"Returns the album based on the specified `albumId` or `shareToken`.
        Exactly one of `albumId` and `shareToken` must be set.
        The `albumId` should be the ID of an album owned by the user or a shared
        album that the user has joined."##),
                  ...
                  vec![
                    (Some(r##"share-token"##),
                     None,
                     Some(r##"Share token of the album to be request. Must not be set if `albumId` is
        set."##),
                     Some(true),
                     Some(false)),
            ...
            ("list",
                    Some(r##"Lists all shared albums available in the Sharing tab of the
